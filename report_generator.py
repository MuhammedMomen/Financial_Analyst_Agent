...
def generate_pdf_report(ratios: FinancialRatios) -> str:
    ...
    try:
      ...
      for ratio_name, ratio_value in ratios.items():
          ...
          pdf.ln(15)
      # Generate PDF in the output directory
      output_dir=Path("output") # this should match with the folder you are using in main and ui files.
      output_dir.mkdir(exist_ok=True)
      output_path = str(output_dir / "financial_report.pdf")  # Output directory report
